...
const projects = [
    ...
    {
        title: 'E-Commerce & Insurtech BI (TokoAman.id)',
        description: 'End-to-end e-commerce and embedded insurance BI analytics featuring sales forecasting, ML customer churn prediction, RFM segmentation, marketing ROI attribution, and checkout A/B testing.',
        category: 'data' as const,
        metric: '+34% ROAS',
        metricLabel: 'Marketing ROI & Churn',
        image: '/images/projects/ecommerce-insurtech-bi.png',
        tags: ['BigQuery', 'SQL', 'Python', 'Power BI', 'RFM', 'A/B Test'],
        link: '/projects/ecommerce-insurtech-bi',
    },
    {
